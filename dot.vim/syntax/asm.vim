...
" 2013/01/31 22:10
syn region asmString	start=/"/ skip=/\\"/ end=/"/ contains=asmEscapeSymbol
syn match asmEscapeSymbol	/\\[ntr]/
" 2013/02/27 00:39
syn match asmCharacter	"\'."
...
" 2013/01/31 21:54
syn match asmRegister	"%[a-z][a-z0-9]\+"
...
if version >= 508 || !exists("did_asm_syntax_inits")
  ...
  HiLink asmEscapeSymbol	Keyword
  HiLink asmRegister		Normal
  HiLink asmString			String

  HiLink asmIdentifier	Identifier
  HiLink asmType	Type

  HiLink asmCharacter	Macro
